...
begin
  ...
  if frmPtSelOptns.cboList.Visible then
    begin
     updateDate := '';
     if Piece(frmPtSelOptns.cboList.Items[frmPtSelOptns.cboList.ItemIndex], U, 3) <> '' then
      updateDate := ' last updated on ' +  Piece(frmPtSelOptns.cboList.Items[frmPtSelOptns.cboList.ItemIndex], U, 3);
      lblPatient.Caption := 'Patients (' + frmPtSelOptns.cboList.Text + updateDate + ')';
    end;
      ...
      begin
        ...
        begin
          ...
          try
            ...
            begin
              aSMARTAction := TfrmNotificationProcessor.Execute(aSmartParams,lstvAlerts.Selected.SubItems.Text);
