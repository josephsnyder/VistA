...
begin
  ...
  if SL.Count > 0 then
    begin
      ...
      if FSignOnDt = 0 then             // vhaishandria 050419
        FSignOnDt := Now;               // vhaishandria 050419
      FName := SL[1];
      FDomainIEN := SL[2];
      FDomain := SL[3];
      FDivisionIEN := SL[4];
...
// vhaishandria 2007-07-18 the next line commented out ------------------- begin
