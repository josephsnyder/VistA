...
//      if StrToIntDef(Piece(FileVersion, '.', 4), 0) > 0 then // vhaishandria 060223
//        Result := Result + 'T' + Piece(FileVersion, '.', 4); // vhaishandria 060223
...
//      Result := 'GMRV*5.0*3T18'; // vhaishandria 060223
    end
  else
    Result := '';
end;
