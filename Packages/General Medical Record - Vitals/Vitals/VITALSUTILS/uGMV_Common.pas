 ...
 * 
 * *****************  Version 2  *****************
 * User: Vhaishandria Date: 7/18/07    Time: 12:50p
...
var
  i: integer;
begin
  Result := iIgnore; // vhaishandria 060123
  if trim(gStr) = '' then Exit;

  i := 1;
  if pos('-',gStr)=1 then i := 2; // vhaishandria 051107
