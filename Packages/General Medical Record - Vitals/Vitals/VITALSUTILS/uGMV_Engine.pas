...
function getClinicFileEntriesByName(aStartFrom, aCount, aDirection: string): TStringList; // vhaishandria 060810
...
begin
  Result := '';
// 060929 vhaishandria LOGSECURITY or LOGSEC ?
...
// 2008-03-10 vhaishandria LOGSECURITY was used before fix
...
function getHospitalLocationByID(anID: string): string;
begin
// vhaishandria 2007-07-17 ----------------------------------------------- Begin
  Result := '';
  if trim(anID) = '' then
    Exit;
// vhaishandria 2007-07-17 -----------------------------------------------   End
  try
...
function getLocationsByAppt(aDFN, aFrom, aTo, aFlag: string): string;
begin
// vhaishandria 2007-07-16 ----------------------------------------------- Begin
  Result := '';
  if trim(aDFN) = '' then
    Exit;
// vhaishandria 2007-07-16 -----------------------------------------------   End
...
//    SL.AddObject(fe.CaptionConverted, fe); // vhaishandria 2008-04-17
