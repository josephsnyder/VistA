 ...
 * 
 * *****************  Version 2  *****************
 * User: Vhaishandria Date: 11/08/07   Time: 2:41p
 ...
 * 
 * *****************  Version 1  *****************
 * User: Vhaishandria Date: 5/14/07    Time: 10:30a
...
//    Location := Patient.LocationName;
    Patient.DFN := DFN; // vhaishandria 2007-11-08 registering access by DFN
      ...
      begin
        with TfrmGMV_PtSelect.Create(Application) do
          begin
            ...
            LoadMessages(Patient);
            Position := poScreenCenter;
            PatientDFN := DFN; // vhaishandria 2007-11-08 registering access by DFN
            PatientName := Patient.Name;  // vhaishandria 2007-11-08
            showmodal;
            if fSelected then
              Result := True
            else
...
{$IFDEF AANTEST} // vhaishandria 060929
  btnAgree.Caption := s;
{$ELSE}
