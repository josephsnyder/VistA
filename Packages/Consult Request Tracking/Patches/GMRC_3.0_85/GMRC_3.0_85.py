...
# Using 54 as the installed system manager to get past this option
class CustomInstaller(DefaultKIDSBuildInstaller):
  def __init__(self, kidsFile, kidsInstallName,
    ...
    assert kidsInstallName == "GMRC*3.0*85"
    DefaultKIDSBuildInstaller.__init__(self, kidsFile,
                                       ...
                                       duz, **kargs)
  """
    @override DefaultKIDSBuildInstaller.runPreInstallationRoutine
  """
