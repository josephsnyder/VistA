...
def pl_test007 (test_suite_details):
    ...
    try:
        ...
        pl.verpatsrch(prob='428.0',snomed='42343007', vlist=['EIGHT,PATIENT', 'ONE,PATIENT', 'TWELVE,PATIENT'])
        for i in range(4):
            pl.rem('655447777')
            pl.rem('543236666')
            pl.rem('345678233')
...
def pl_test008 (test_suite_details):
    ...
    try:
        ...
        pl2 = PLActions(VistA2, user='fakedoc1', code='1Doc!@#$')
        pl2.signon()
        pl2.editsimple(ssn='666551234', probnum='1', itemnum='1', chgval='786.50',snomed='29857009')
...
def pl_test012(test_suite_details):
    ...
    try:
        ...
        pl.signon()
        pl.addcsv(ssn='656451234', pfile='./Functional/dataFiles/probdata0.csv')
        pl.detview(ssn='656451234', probnum='2', vlist1=['444.9', 'ACTIVE', 'ALEXANDER'], vlist2=['hurts'])
        pl.rem(ssn='656451234')
        pl.rem(ssn='656451234')
        pl.checkempty(ssn='656451234')
        pl.signoff()
        ...
        p3.add(ssn='656451234', clinic='Clinic1', comment='this is a test',
               ...
               icd='786.2',snomed='49727002', verchknum='2')
        p3.signoff()
...
def pl_test015(test_suite_details):
    ...
    try:
        ...
        pl2 = PLActions(VistA2, user='fakedoc1', code='1Doc!@#$')
        pl2.signon()
        pl2.badeditpart1(ssn='656451234', probnum='1', itemnum='1', chgval='786.50', snomed='29857009')
        pl2.signoff()
        pl1.editpart2(ssn='656451234', probnum='1', itemnum='1', chgval='786.50', snomed='29857009')
        pl1.rem_all(ssn='656451234')
        pl1.signoff()
