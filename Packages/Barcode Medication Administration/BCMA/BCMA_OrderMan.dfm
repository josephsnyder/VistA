object frmCPRSOrderManager: TfrmCPRSOrderManager
  ...
  object GroupBox2: TGroupBox
    ...
    object Label3: TLabel
      ...
      FocusControl = edtActionDateTime
  ...
  object VA508AccessibilityManager1: TVA508AccessibilityManager
    ...
    Data = (
      ...
      (
        ...
        'Status = stsOK')
      (
        'Component = cbxIntSyringe'
        'Label = lblIntSyringe'
        'Status = stsOK')
      (
        'Component = cbxSchedule'
        'Label = lblSchedule'
        'Status = stsOK')
      (
        'Component = frmCPRSOrderManager'
        'Status = stsDefault'))
  end
end
