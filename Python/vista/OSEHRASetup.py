...
def removeHINQ(VistA):
  startFileman(VistA)
  VistA.write('1')
  VistA.wait('INPUT TO WHAT FILE')
  VistA.write('MAS PARAMETERS')
  VistA.wait('EDIT WHICH FIELD')
  VistA.write('USE HINQ INQUIRY')
  VistA.wait('THEN EDIT FIELD')
  VistA.write('')
  VistA.wait('MAS PARAMETERS ONE')
  VistA.write('1')
  VistA.wait('USE HINQ INQUIRY')
  VistA.write('No')
  VistA.wait('MAS PARAMETERS ONE')
  VistA.write('')
  VistA.wait('OPTION')
...
def setupOutpatientSite(VistA,sitename,sitenum):
  startFileman(VistA)
  VistA.write('1')
  VistA.wait('INPUT TO WHAT FILE')
  VistA.write('OUTPATIENT SITE')
  VistA.wait('EDIT WHICH FIELD')
  VistA.write('SITE NUMBER')
  VistA.wait('THEN EDIT FIELD')
  VistA.write('INACTIVE DATE')
  VistA.wait('THEN EDIT FIELD')
  VistA.write('SHALL COMPUTER ASSIGN RX')
  VistA.wait('THEN EDIT FIELD')
  VistA.write('PRESCRIPTION # LOWER BOUND')
  VistA.wait('THEN EDIT FIELD')
  VistA.write('PRESCRIPTION # UPPER BOUND')
  VistA.wait('THEN EDIT FIELD')
  VistA.write('NARCOTIC LOWER BOUND')
  VistA.wait('THEN EDIT FIELD')
  VistA.write('NARCOTIC UPPER BOUND')
  VistA.wait('THEN EDIT FIELD')
  VistA.write('')
  index = VistA.multiwait(['OUTPATIENT SITE NAME','STORE THESE FIELDS'])
  if index == 1:
    VistA.write('')
    VistA.wait('OUTPATIENT SITE NAME')
  VistA.write(sitename)
  index = VistA.multiwait(['Are you adding','SITE NUMBER'])
  if index == 0:
    VistA.write('Y')
    VistA.wait('SITE NUMBER')
    VistA.write(sitenum)
    VistA.wait('INACTIVE DATE')
    VistA.write('T+104W')
    VistA.wait('SITE NUMBER')
  VistA.write(sitenum)
  VistA.wait('INACTIVE DATE')
  VistA.write('T+104W')
  VistA.wait('SHALL COMPUTER ASSIGN RX')
  VistA.write('Yes')
  VistA.wait('PRESCRIPTION # LOWER BOUND')
  VistA.write('1')
  VistA.wait('PRESCRIPTION # UPPER BOUND')
  VistA.write('999999')
  VistA.wait('NARCOTIC LOWER BOUND')
  VistA.write('1000000')
  VistA.wait('NARCOTIC UPPER BOUND')
  VistA.write('1100000')
  VistA.wait('OUTPATIENT SITE NAME')
  VistA.write('')
  VistA.wait('OPTION')
...
def setupOperatingRoom(VistA,ORName,ORAbbrev,ORLoc,ORType):
  # To add an operating room, there must first be an OR typed
  # entry in the HOSPITAL LOCATION file
  #
  startFileman(VistA)
  VistA.write('ENTER')
  VistA.wait('INPUT TO WHAT FILE')
  ...
  VistA.wait('EDIT WHICH FIELD')
  VistA.write('')
  VistA.wait('HOSPITAL LOCATION NAME')
  VistA.write(ORName)
  index = VistA.multiwait(['Are you adding','NAME'])
  if index==0:
    VistA.write('Y')
    VistA.wait('HOSPITAL LOCATION TYPE')
    VistA.write('OR')
    VistA.wait('TYPE EXTENSION')
    VistA.write('')
  else:
    VistA.write('')
  VistA.wait('ABBREVIATION')
  VistA.write(ORAbbrev)
  VistA.wait('TYPE')
  VistA.write('')
  VistA.wait('TYPE EXTENSION')
  VistA.write('')
  ...
  VistA.wait('HOSPITAL LOCATION NAME')
  VistA.write('')
  #  Once the HOSPITAL LOCATION entry exists, we can go to the
  #  OPERATING ROOM file and finish the set up.
  VistA.wait('Select OPTION')
  VistA.write('ENTER')
  VistA.wait('INPUT TO WHAT FILE')
  VistA.write('OPERATING ROOM')
  VistA.wait('CHOOSE')
  VistA.write('1')
  VistA.wait('EDIT WHICH FIELD')
  VistA.write('')
  VistA.wait('OPERATING ROOM NAME')
  VistA.write(ORName)
  ...
  VistA.wait('TYPE')
  VistA.write(ORType)
  VistA.wait('CLEANING TIME')
  VistA.write('30')
  for i in range(0,7):
    VistA.wait('DAY OF THE WEEK')
    VistA.write(str(i))
    VistA.wait('Are you adding')
    VistA.write('Y')
    VistA.wait('NORMAL START TIME')
    VistA.write('08:00')
    VistA.wait('NORMAL END TIME')
    VistA.write('17:00')
    VistA.wait('INACTIVE')
    VistA.write('N')
  VistA.wait('DAY OF THE WEEK')
...
def addNurseToStaff(VistA,nurname):
  ...
  VistA.wait('Nursing System Manager')
  VistA.write('')
  index = VistA.multiwait(['Do you really',VistA.prompt])
  if index == 0:
    VistA.write('Y')
    VistA.wait(PROMPT)
  VistA.write('')
...
def setupPharmacyUser(VistA,provname,DEAnum):
  ...
  VistA.wait('DEA#')
  VistA.write(DEAnum)
  index = VistA.multiwait(['DETOX','VA'])
  VistA.write('^')
  VistA.wait('Select Provider')
  VistA.write('')
